...
## Project Structure
    ...
    ├── testapiautoconnecto_91455  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_91455`
...
2. Clone this repo and `cd testapiautoconnecto_91455`
